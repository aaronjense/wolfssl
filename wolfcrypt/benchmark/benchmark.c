        ...
        int rsaKeySz)
{
    ...
    DECLARE_DYNAMIC(enc, byte, BENCH_MAX_PENDING, rsaKeySz/8, HEAP_HINT);
    DECLARE_DYNAMIC(out, byte, BENCH_MAX_PENDING, rsaKeySz/8, HEAP_HINT);
...
exit_rsa_verify:
    ...
    FREE_DYNAMIC(enc, BENCH_MAX_PENDING, HEAP_HINT);
    FREE_DYNAMIC(out, BENCH_MAX_PENDING, HEAP_HINT);
